...
static const int systraypinningfailfirst = 1;   /* 1: if pinning fails, display systray on the first monitor, False: displa    y systray on the last monitor*/
...
static const Rule rules[] = {
	...
	{ NULL,     "slack",			 NULL,       1 << 8,	0,			      0,            1 },
	{ NULL,     "spotify",    		 NULL,       1 << 7,    0,	 	 	      0,            1 },
	{ NULL,     "brave-browser",     NULL,       0,         1,	 	 	      0,           -1 },
	{ NULL,     "vmware",            NULL,       1,         0,                0,            0 }
...
static Key keys[] = {
	...
	{ MODKEY,						XK_Tab,	   spawn,		   {.v = browsercmd } },
	...
	{ MODKEY|ShiftMask,				XK_m,      spawn,		SHCMD("systemctl suspend") },
